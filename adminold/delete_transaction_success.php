        ...
        <main>
            <!-- login form -->
                ...
                <div class="admin-container">
                    ...
                    <div class="data-box">
                            <div>
                                <h1 style="color:red;">Transaction successfully deleted.</h1>
                                <a href="transactions.php"><button 
                                    style="font-size:25px;padding:10px;border-radius:15px;background-color:green;color:white;border:none;
                                            box-shadow:0px 0px 5px 1px black;cursor:pointer;margin-top:15px;">
                                Proceed to transactions</button>
                            </a>
                            </div>
                    </div>
                </div>
