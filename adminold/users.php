                ...
                <table   style="width:100%;text-align:left;">
                    ...
                    while($r_result = mysqli_fetch_array($request_result)){
                            ...
                            echo    "<td>".$r_result['request_id']." </td>
                                    <td><div style=\"width:90px; height:90px;background-color:#888;border-radius:50%;overflow:hidden;\"> </div></td>
                                    <td>".$r_result['request_type']." </td>
                                    <td>".$r_result['request_fee']." </td>
                                    <td>".$r_result['request_by']."</td>";
                            

                             echo   "<td><div style=\"width:200px;height:100px;border:1px solid red;padding:10px;color:white;background-color:#888;\">".$r_result['request_comment']."</div></td>
                                   
                                    <td><small>".$r_result['request_brgy']."</small></td>
                                    <td><small>".$r_result['request_date']."</small></td>
                                    
                                    <td><small>".$r_result['request_last_modified']."</small></td>
                                    <td>
                                    <a 
