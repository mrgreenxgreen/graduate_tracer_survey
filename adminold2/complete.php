            ...
            <!-- login form -->
                ...
                <div class="admin-container">
                    ...
                    <div class="data-box">
                          ...
                          <form action="complete-confirm.php"  method="POST" style="display:flex;flex-direction:column;justify-content:center;align-items:center;">
						  <h1> Complete Transaction </h1>   
						  <p >Enter Message </p>
                            <input type="text" name="Complete_Message" style="width:400px; height:300px;" />
                           <?php echo "<input type=\"hidden\" name=\"request_id\" value=\"". $id ."\" />";  ?>
									<br/>
                            <input type="Submit" name="Submit_Completed"  style="width:200px;margin:auto;"/>
                            <br/>
