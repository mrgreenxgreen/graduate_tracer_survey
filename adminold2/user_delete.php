...
if(isset($_POST['Submit-delete'])){
    $entered_security = $_POST['security_password'];
    $user_password = $_SESSION['sessionAdminPassword'];
    if($entered_security == $user_password){
        echo "PROCEED TO DELETE   ";
        $SQL_DELETE = "UPDATE transactions SET isDeleted = 1 WHERE transaction_id = $id";
        $result_delete = mysqli_query($mysqli, $SQL_DELETE);
        header("Location:delete_transaction_success.php");
    }else{
                ...
                <div class="admin-container">
                    ...
                    <div class="data-box">
                            <div style="padding-top:10em;text-align:center;">
                                <i class="fa-solid fa-trash" style="font-size:120px;"></i>
                                <h1>To continue to delete user</h1>
                                <form method="POST"
                                style="display:flex;align-items:center;justify-content:center;">
                                    ...
                                    <input 
                                        ...
                                        style="width:400px;padding:10px;margin:10px;border-radius:15px;"
                                    />
                                    </div>
                                    <div style="display:flex;gap:10px;">
                                    <input type="submit" name="Submit-delete" value="Proceed"/>
                                    <button><a href="transactions.php">Cancel </a></button>
                                    </div>
