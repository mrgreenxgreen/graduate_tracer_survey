            ...
            <!-- login form -->
                ...
                <div class="admin-container">
                    ...
                    <div class="data-box">
                          ...
                          <form action="reject-confirm.php"  method="POST" style="display:flex;flex-direction:column;">
                            <p>Enter Message </p>
                            <input type="text" name="Cancel_Message" style="width:400px; height:300px;">
                           <?php echo "<input type=\"hidden\" name=\"request_id\" value=\"". $id ."\" />";  ?>

                            <input type="Submit" name="Submit_Cancelled"  />
                            <br/>
